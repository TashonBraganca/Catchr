...
export const API_ENDPOINTS = {
    ...
    THOUGHTS: {
        LIST: '/api/thoughts',
        CREATE: '/api/thoughts',
        DETAIL: (id) => `/api/thoughts/${id}`,
        UPDATE: (id) => `/api/thoughts/${id}`,
        DELETE: (id) => `/api/thoughts/${id}`,
...
export const AI_CONFIG = {
    OPENAI: {
        MODEL: 'gpt-4o-mini', // Using GPT-4o-mini as specified in REVAMP.md AI instructions
        MAX_TOKENS: 1000,
        TEMPERATURE: 0.7,
    },
    TRANSCRIPTION: {
        ...
        FALLBACK_CHAIN: ['huggingface', 'openai', 'webspeech'],
    },
    CATEGORIZATION: {
        MIN_CONFIDENCE: 0.7,
        MAX_SUGGESTIONS: 3,
